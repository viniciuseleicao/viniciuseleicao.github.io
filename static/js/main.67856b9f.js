...
(() => {
	...
	(t.m = e),
		...
		(() => {
			...
			var n = (n, r) => {
				...
				r = (self.webpackChunkvinicius_pereira =
					self.webpackChunkvinicius_pereira || []);
	...
	const s = function () {
			return (
				(0, r.useEffect)(() => {
					document.title = "Vinicius Pereira";
				}, []),
				(0, i.jsxs)("div", {
					id: "parent",
					children: [
						...
						(0, i.jsx)("footer", {
							id: "cnpj",
							children:
								"VINICIUS PEREIRA DA SILVA VEREADOR CNPJ 56.492.187/0001-42",
						}),
					],
				})
			);
